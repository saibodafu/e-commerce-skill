...
| Skill | 适合解决什么问题 | 主要输出 |
|---|---|---|
| `ecommerce-review-insight` | 基于真实用户评论，分析人群、场景、痛点、竞品和优化机会 | Excel 结构表、图表、词云、评论洞察报告 |
| `ecommerce-content-wireframe` | 从产品信息出发，梳理详情页内容结构和黑白线框稿 | 详情页内容文档、手机长图 HTML 黑白线框稿 |
| `ecommerce-detail-page-visual-design` | 把已有详情页文案、原型图和包装图转成逐屏视觉设计 | 逐屏分析、视觉风格、AI 生图提示词、750px 长图 |
| `xhs-product-content-cards` | 把产品卖点、选购标准、竞品对比或避坑主题转成小红书图文卡片 | 2-4 张小红书卡片方案、逐页文案、AI 出图提示词 |

## 推荐使用顺序

如果你从真实评论出发，可以按这条链路推进：
...
## Skill 1：ecommerce-review-insight
...
## Skill 2：ecommerce-content-wireframe
...
## Skill 3：ecommerce-detail-page-visual-design
...
## Skill 4：xhs-product-content-cards
